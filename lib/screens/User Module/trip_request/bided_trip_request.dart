...
import 'package:trailer_tracking/screens/User%20Module/trip_request/trip_status_screen.dart';
...
class BidTripRequestScreen extends StatefulWidget {
  const BidTripRequestScreen({Key? key}) : super(key: key);

  @override
  State<BidTripRequestScreen> createState() => _BidTripRequestScreenState();
}

class _BidTripRequestScreenState extends State<BidTripRequestScreen> {
       ...
       Container(
         ...
         child: SingleChildScrollView(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                AppUtils().BidAppBar(context, "Trip Requests"),
                InkWell(
                  onTap: (){
                    Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=> TripStatusScreen(tripStatus: "Requested",)));
                  },
                  child: Padding(
                ...
                InkWell(
                  onTap: (){
                    Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=> TripStatusScreen(tripStatus: "Transporter Requested",)));
                  },
                  child: Padding(
                    padding: const EdgeInsets.all(20.0),
                    child: Container(
