...
class TransporterHomeDrawer extends StatefulWidget {
  const TransporterHomeDrawer({Key? key, this.screenIndex, this.iconAnimationController, this.callBackIndex}) : super(key: key);
  ...
  @override
  _TransporterHomeDrawerState createState() => _TransporterHomeDrawerState();
}

class _TransporterHomeDrawerState extends State<TransporterHomeDrawer> {
  ...
  void setDrawerListArray() {
    drawerList = <DrawerList>[
      ...
      DrawerList(
        index: DrawerIndex.driverDetails,
  ...
  void onTapped() {
    Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=> LoginScreen()));// Print to console.
  }
