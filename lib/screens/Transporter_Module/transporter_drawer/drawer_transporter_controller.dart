...
class DrawerTransporterController extends StatefulWidget {
  const DrawerTransporterController({
    Key? key,
  ...
  @override
  _DrawerTransporterControllerState createState() => _DrawerTransporterControllerState();
}

class _DrawerTransporterControllerState extends State<DrawerTransporterController> with TickerProviderStateMixin {
              ...
              SizedBox(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: <BoxShadow>[
                      BoxShadow(color: AppColors.closeIconColor.withOpacity(0.6), blurRadius: 24),
                    ],
                  ),
                  child: Stack(
                    children: <Widget>[
