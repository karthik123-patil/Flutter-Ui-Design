...
import 'package:trailer_tracking/screens/Transporter_Module/wallet/wallet_activities_screen.dart';
...
class TransporterWalletScreen extends StatefulWidget {
  static const String id = StringConstants.walletScreen;
  const TransporterWalletScreen({Key? key}) : super(key: key);

  @override
  _TransporterWalletScreenState createState() => _TransporterWalletScreenState();
}

class _TransporterWalletScreenState extends State<TransporterWalletScreen> {
                  ...
                  child: ElevatedButton(
                    ...
                    child: Row(
                      children: [
                        ...
                        const Text("Paytm", style: TextStyle(color:AppColors.textColor, fontSize: 14, fontWeight: FontWeight.w500,letterSpacing: 1, fontFamily: "Poppins", fontStyle: FontStyle.normal)),
                      ],
                    ),
                  ),
                  ...
                  child: ElevatedButton(
                    ...
                    child: Row(
                      children: [
                        ...
                        const SizedBox(width: 5,),
                        const Text("Razor Pay", style: TextStyle(color:AppColors.textColor, fontSize: 14, fontWeight: FontWeight.w500,letterSpacing: 1, fontFamily: "Poppins", fontStyle: FontStyle.normal)),
                      ],
                    ),
                  ),
      ...
      child: Scaffold(
        ...
        SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: [
                AppUtils().WalletAppBar(context, "Wallet"),
                Padding(
                            ...
                            decoration: InputDecoration(
                              ...
                              suffix: TextButton(
                                ...
                                child: Text(
                                    'Add money',
                                    style: TextStyle(
                                        color: isShow?AppColors.blueColor:AppColors.blueColor.withOpacity(0.2),
                                        fontSize: 12.0,
                                        fontWeight: FontWeight.w500,
                                        letterSpacing: 0.2,
                                        fontFamily: "Poppins",
                              ...
                              Row(
                                children: [
                                  InkWell(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                          color: isShow500 ?AppColors.textColor :AppColors.whiteColor,
                                  ...
                                  InkWell(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                          color: isShow1000 ?AppColors.textColor :AppColors.whiteColor,
                                          borderRadius:const BorderRadius.all(Radius.circular(20)),
                                          border: Border.all(
                                            color: AppColors.closeIconColor,
                                          )
                                  ...
                                  InkWell(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                          color: isShow1500 ?AppColors.textColor :AppColors.whiteColor,
                                          borderRadius:const BorderRadius.all(Radius.circular(20)),
                                          border: Border.all(
                                            color: AppColors.closeIconColor,
                                          )
                              ...
                              Row(
                                children: [
                                  InkWell(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                          color: isShow2000 ?AppColors.textColor :AppColors.whiteColor,
                                          borderRadius: const BorderRadius.all(Radius.circular(20)),
                                          border: Border.all(
                                            color: AppColors.closeIconColor,
                                          )
                                  ...
                                  InkWell(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                          color: isShow2500 ?AppColors.textColor :AppColors.whiteColor,
                                          borderRadius:const BorderRadius.all(Radius.circular(20)),
                                          border: Border.all(
                                            color: AppColors.closeIconColor,
                                          )
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: InkWell(
                    onTap: ()=>Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>TransporterWalletActivitiesScreen())),
                    child: Container(
                      decoration:const BoxDecoration(
                          color: AppColors.whiteColor,
...
class CashInfoBottomDialog {
  ...
  Widget _buildImage() {
    const image =
        "assets/images/img_hand_cash_info.png";
    return SizedBox(
      height: 60,
