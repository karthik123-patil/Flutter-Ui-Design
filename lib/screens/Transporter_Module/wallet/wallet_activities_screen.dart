...
class TransporterWalletActivitiesScreen extends StatefulWidget {
  static const String id = StringConstants.walletActivitiesScreen;
  const TransporterWalletActivitiesScreen({Key? key}) : super(key: key);

  @override
  _TransporterWalletActivitiesScreenState createState() => _TransporterWalletActivitiesScreenState();
}

class _TransporterWalletActivitiesScreenState extends State<TransporterWalletActivitiesScreen> {
